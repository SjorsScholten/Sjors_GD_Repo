...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        private bool SphereCastToGround(out RaycastHit hitInfo) {
            var radius = m_Capsule.radius * (1.0f - advancedSettings.shellOffset);
            var distance = ((m_Capsule.height / 2f) - m_Capsule.radius) + advancedSettings.groundCheckDistance;
            return Physics.SphereCast(transform.position, radius, Vector3.down, out hitInfo, distance, Physics.AllLayers, QueryTriggerInteraction.Ignore);
        }
    }
}
